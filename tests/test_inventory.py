...
class TestSwitch:
    ...
    def test_switch_creation(self, sample_switch: Switch):
    ...
    def test_switch_display_name(self, sample_switch: Switch):
...
class TestSite:
    ...
    def test_site_get_switch(self, sample_switch: Switch):
...
class TestInventoryParser:
    ...
    def test_load_inventory(self, inventory_parser: InventoryParser):
        """Test inventory loads successfully."""
        sites = inventory_parser.get_sites()
        assert len(sites) == 2

    def test_get_site_by_id(self, inventory_parser: InventoryParser):
    ...
    def test_get_nonexistent_site(self, inventory_parser: InventoryParser):
        """Test getting non-existent site returns None."""
        site = inventory_parser.get_site("999")
        assert site is None

    def test_get_switch(self, inventory_parser: InventoryParser):
    ...
    def test_get_switch_lr2(self, inventory_parser: InventoryParser):
    ...
    def test_switch_vendor_mapping(self, inventory_parser: InventoryParser):
    ...
    def test_switch_credentials(self, inventory_parser: InventoryParser):
    ...
    def test_reload_inventory(self, inventory_parser: InventoryParser):
